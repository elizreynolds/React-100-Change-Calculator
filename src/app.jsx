          ...
          <div className='col-sm-8'>
            <div className='panel panel-default'>
              <div className='panel-body'>
                ...
                <div className='row'>
                  <div className="col-sm-2 well well-sm  text-center"><strong> Twenties </strong>
                    <p className='change'>{this.state.twenties}</p>
                  </div>
                </div>
                <div className="col-sm-2 well well-sm text-center"><strong> Tens </strong>
                  <p className='change'>{this.state.tens}</p>
                </div>
                <div>
                  <div className="col-sm-2 well well-sm text-center"><strong> Fives </strong>
                    <p className='change'>{this.state.fives}</p>
                  </div>
                </div>
                <div className="col-sm-2 well well-sm text-center"><strong> Ones </strong>
              ...
              <div className='col-sm-3 well well-sm text-center'><strong> Pennies </strong>
